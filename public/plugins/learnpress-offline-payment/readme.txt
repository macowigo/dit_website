...
LearnPress Offline Payment help you to manually create order for offline payment instead of paying via any payment gateways to sell course.
...
2. Search for 'LearnPress Offline Payment'.
3. Activate LearnPress from your Plugins page.

**From WordPress.org**
1. Search, select and download LearnPress Offline Payment.
2. Activate the plugin through the 'Plugins' menu in WordPress Dashboard.

== Frequently Asked Questions ==

= Can I create an add-on for LearnPress like LearnPress Offline Payment by myself? =
