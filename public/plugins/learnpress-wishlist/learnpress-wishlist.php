...
class LP_Addon_Wishlist_Preload {
	...
	public function load() {
		...
		$version = get_plugin_data( LP_ADDON_WISHLIST_FILE )['Version'];
		define( 'LP_ADDON_WISHLIST_VER', $version );
	...
	public function admin_notices() {
		...
		<div class="error">
			<p><?php echo wp_kses(
					sprintf(
						__( '<strong>%s</strong> addon version %s requires %s version %s or higher is <strong>installed</strong> and <strong>activated</strong>.',
							'learnpress-wishlist' ),
						...
						sprintf( '<a href="%s" target="_blank"><strong>%s</strong></a>',
							...
							__( 'LearnPress', 'learnpress-wishlist' ) ),
