				...
				success(res) {
					if ('success' === res.status) {
						...
						$.each($xml.find('channel item'), function () {
							...
							content_html.push('<div class="item-blog"><h3><a href="' + link + '?utm_source=lp-post&utm_medium=dash&utm_campaign=lp-news-feed" target="_blank">' + title + '</a></h3><p>' + description + '</p></div>');
						});
