...
class LP_Upgrader{
    ...
    function __construct( $directories = array() ){
        ...
        if( ! class_exists( 'WP_Upgrader_Skin' ) ){
            require_once( ABSPATH . 'admin/includes/class-upgrader-skins.php' );
        ...
        $this->strings['fs_no_content_dir'] = __( 'Unable to locate WordPress Content directory (content).', 'learnpress' );
