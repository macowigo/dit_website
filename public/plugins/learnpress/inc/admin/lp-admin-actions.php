...
/*function _learn_press_set_user_items( $query ) {
	...
	if ( ! function_exists( 'wp_get_current_user' ) ) {
		include( ABSPATH . "includes/pluggable.php" );
	}
...
function learn_press_active_course_menu() {
	...
	<script type="text/javascript">
		jQuery(function ($) {
			...
			$lpMainMenu.addClass('has-current-submenu menu-open').removeClass('not-current-submenu');
			$lpMainMenu.children('a').addClass('has-current-submenu menu-open').removeClass('not-current-submenu');
			<?php
			}
			?>
		});
