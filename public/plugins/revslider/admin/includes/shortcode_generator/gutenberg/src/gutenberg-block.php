...
if( ! class_exists( 'RevSliderGutenberg' ) ) {
	...
	class RevSliderGutenberg {
		 ...
		 *
		 * @uses {editor} for WP editor styles.
		 * @since 1.0.0
		 */
		public function revslider_gutenberg_cgb_block_assets() { // phpcs:ignore
			...
			wp_enqueue_style(
				...
				array( 'editor' ) // Dependency to include the CSS after it.
		 ...
		 *
		 * @uses {blocks} for block type registration & related functions.
		 * @uses {element} for WP Element abstraction — structure of blocks.
		 * @uses {i18n} to internationalize the block's text.
		 * @uses {editor} for WP editor styles.
		 * @since 1.0.0
		 */
		public function revslider_gutenberg_cgb_editor_assets() { // phpcs:ignore
			...
			wp_enqueue_script(
				...
				array( 'blocks', 'i18n', 'element', 'editor' ), // Dependencies, defined above.
			...
			wp_enqueue_style(
				...
				array( 'edit-blocks' ) // Dependency to include the CSS after it.
