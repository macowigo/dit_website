...
class RevSliderAdmin extends RevSliderFunctionsAdmin {
	...
	public function enqueue_admin_styles(){
		...
		wp_enqueue_style(array('jquery-ui', 'jquery-ui-core', 'jquery-ui-dialog', 'color-picker'));
	...
	public function enqueue_admin_scripts(){
		...
		wp_enqueue_script(array('jquery', 'jquery-ui-core', 'jquery-ui-mouse', 'jquery-ui-accordion', 'jquery-ui-datepicker', 'jquery-ui-dialog', 'jquery-ui-slider', 'jquery-ui-autocomplete', 'jquery-ui-sortable', 'jquery-ui-droppable', 'jquery-ui-tabs', 'jquery-ui-widget', 'color-picker', 'wpdialogs', 'updates'));
		wp_enqueue_script(array('color-picker'));
		/**
		...
		*/
		...
		if(in_array($this->get_val($_GET, 'page'), $this->pages)){
			...
			if($this->dev_mode){
				...
				wp_enqueue_script('revbuilder-color-picker-js', RS_PLUGIN_URL . 'admin/assets/js/plugins/tp-color-picker.min.js', array('jquery', 'revbuilder-select2RS', 'color-picker'), RS_REVISION);
				...
				wp_localize_script('revbuilder-admin', 'RVS_LANG', $this->get_javascript_multilanguage()); //Load multilanguage for JavaScript
				wp_enqueue_script('revbuilder-utils', RS_PLUGIN_URL . 'admin/assets/js/plugins/utils.min.js', array('jquery', 'color-picker'), RS_REVISION, false);
			}
