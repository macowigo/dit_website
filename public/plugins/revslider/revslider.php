...
define('RS_TP_TOOLS',			'6.2.22'); //holds the version of the tp-tools script, load only the latest!
...
try{
	...
	function rev_slider_shortcode($args, $mid_content = null){
		...
		if(!empty($zindex)){
			$content = '<div class="block-themepunch-revslider" style="z-index:'.$zindex.';">' .$content. '</div>';
		}
