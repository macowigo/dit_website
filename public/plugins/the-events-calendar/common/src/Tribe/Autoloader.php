<?php
	...
	if ( ! class_exists( 'Tribe__Autoloader' ) ) {
		 ...
		 * Example usage:
		 *
		 *      // will be `/var/www/site/content/plugins/the-events-calendar'
		 ...
		 *      // `/var/www/site/content/plugins/the-events-calendar/src/Tribe/admin/Some_Class.php'
		 *      // and
		 *      // `/var/www/site/content/plugins/the-events-calendar/src/Tribe/another-dir/Some_Class.php'
		 *      $i = new Tribe__Admin__Some_Class();
		 *
		 *      // class will be searched in the path
		 *      // `/var/www/site/content/plugins/the-events-calendar/utils/some-dir/Some_Util.php'
		 *      $i = new Tribe__Utils__Some_Util();
		 *
		 *      // class will be searched in the path
		 *      // `/var/www/site/content/plugins/the-events-calendar/deprecated/Tribe_DeprecatedClass.php'
		...
		class Tribe__Autoloader {
			 ...
			 * E.g. `/var/www/tribe-pro/content/plugins/the-events-calendar/src/Tribe`
			 *
			 * @var string[][]
			 */
			protected $prefixes;
