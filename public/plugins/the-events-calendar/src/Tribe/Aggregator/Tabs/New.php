	...
	public function get_result_messages( $queue ) {
		...
		if ( ! $is_queued ) {
			...
			if ( ! empty( $item_updated ) ) {
				...
				// @todo [BTRIA-589]: Include a part of sentence like: ", including %1$d %2$signored event%3$s.", <a href="/admin/edit.php?post_status=tribe-ignored&post_type=tribe_events">, </a>.
