...
jQuery( function( $ ) {
	...
	$( '[data-lists="list:tribe_events_cat"]' ).each( function() {
		var $list = $( this );
	...
	var eventSubmitButton = $( '.admin.events-cal #post #publishing-action input[type="submit"]' );
	...
	if ( $( 'body' ).hasClass( 'post-type-tribe_venue' ) ) {
		$( '#menu-posts-tribe_events, #menu-posts-tribe_events a.has-submenu' )
			.addClass( 'menu-open has-current-submenu has-submenu' )
			.removeClass( 'not-current-submenu' )
