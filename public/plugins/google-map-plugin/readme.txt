...
<strong> <a href='https://codecanyon.net/item/advanced-google-maps-plugin-for-wordpress/5211638' target='_blank'> Features available in Pro version</a> </strong>
...
* A Cross Browser Compatible plugin. Fully tested on IE8, IE9, IE10 and all major browsers
* Multisite Enabled and ability to activate it network wide.
* Visit our Pro Edition [WP Google Map](http://codecanyon.net/item/advanced-google-maps/5211638)
...
This section describes how to install the plugin and get it working.
	...
	1.	Upload the <strong>google-map-plugin</strong> directory to the <strong>/content/plugins/</strong> folder

	2.	Once the plugin is uploaded log into WordPress and go to <strong>Plugins</strong>

	3.	Find the <strong>google-map-plugin</strong>plugin and click Activate Plugin
...
== Screenshots ==
1. Google Autosuggest enabled location form to add marker data quickly.
2. Easy interface to edit or remove existing locations. You can search within your locations. 
3. Quickly create your map with extensive settings and then use a shortcode to display the map.
4. You can create any number of maps and each map will have own shortcode.
5. Create a marker category and assign an icon to the category. Choose from +500 ready-made icons.
6. Manage your markers category easily.
7. Easy to use Settings page to choose your map language and setup your maps API key.
8. How to Use page helps you get started quickly. 
9. Add your map in the widget easily.
10. Display Streetview Controller.
...
= 3.0.5 =
* Lang slug changed to google-map-plugin as per wordpress.org requested.
...
Yes, You can click on [Google Maps Pro Live Demo](http://www.flippercode.com/product/google-map-pro/) and mail us at hello at flippercode dot com if any pre-purchase query.

= Do we have a Documentation? =
Yes, You can click on [WP Google Map Pro Guide](https://www.wpmapspro.com/tutorials) and you will get all documentation with proper steps and video tutorials.
