<?php
	...
	*/
	...
	gdlr_core_page_builder_element::add_element('google-map-plugin', 'gdlr_core_pb_element_wp_google_map_plugin'); 
	...
	if( !class_exists('gdlr_core_pb_element_wp_google_map_plugin') ){
		class gdlr_core_pb_element_wp_google_map_plugin{
					...
					'general' => array(
						...
						'options' => array(
							...
							'wpgmap2-id' => array(
								...
								'description' => esc_html__('This option will be ignored if you select the map from google-map-plugins', 'goodlayers-core')
							)				
						)
					),
					'spacing' => array(
			...
			static function get_content( $settings = array(), $preview = false ){
				...
				$ret  = '<div class="gdlr-core-google-map-plugin-item gdlr-core-item-pdlr gdlr-core-item-pdb ' . esc_attr($extra_class) . '" ';
				...
				if( !defined('TBL_MAP') && empty($wpgmza_tblname_maps) ){
					$message = wp_kses(__('Please install and activate the "<a target="_blank" href="https://wordpress.org/plugins/google-map-plugin/" >Wp Google Map Plugin</a>" or "<a target="_blank" href="https://wordpress.org/plugins/google-maps/" >Wp Google Maps</a>" plugin to show the map.', 'goodlayers-core'), 
