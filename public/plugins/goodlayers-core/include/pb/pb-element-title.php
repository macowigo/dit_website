					...
					'style' => array(
						...
						'options' => array(
							...
							'left-divider-size' => array(
								'title' => esc_html__('Left Divider Size', 'goodlayers-core'),
								'type' => 'text',
								'data-input-type' => 'pixel',
								'condition' => array( 'left-media-type' => 'divider' )
							),
							'left-divider-margin' => array(
								'title' => esc_html__('Left Divider Margin', 'goodlayers-core'),
								'type' => 'text',
								'data-input-type' => 'pixel',
								'condition' => array( 'left-media-type' => 'divider' )
							),
		...
		jQuery(window).load(function(){
			...
			static function get_content( $settings = array(), $preview = false ){
				...
				if( !empty($settings['title']) ){
					...
					if( !empty($settings['left-media-type']) && $settings['left-media-type'] == 'divider' ){
