		...
		class gdlr_core_pb_wrapper_column{
			...
			static function get_template( $options = array(), $callback = '' ){
				...
				if( !empty($options['value']['hover-border-color']) ){
					$custom_style .= '#custom_style_id .gdlr-core-pbf-column-content-margin:hover, ';
					$custom_style .= '#custom_style_id .gdlr-core-pbf-column-content-margin:hover .gdlr-core-pbf-background-wrap, ';
					$custom_style .= '#custom_style_id .gdlr-core-pbf-column-content-margin:hover .gdlr-core-pbf-background-frame{ border-color: ' . $options['value']['hover-border-color'] . ' !important; }';
				}
				if( !empty($options['value']['hover-border-width']) ){
					$custom_style .= '#custom_style_id .gdlr-core-pbf-column-content-margin:hover .gdlr-core-pbf-background-wrap{ ' . gdlr_core_esc_style(array('border-width' => $options['value']['hover-border-width']), false, true) . ' }';
				}
