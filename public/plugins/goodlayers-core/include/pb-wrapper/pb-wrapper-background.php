					...
					'effect' => array(
						...
						'options' => array(
							'wrapper-background-gradient' => array(
								'title' => esc_html__('Wrapper Background Top/Bottom Gradient', 'dit'),
								'type' => 'combobox',
								'options' => array(
									'none' => esc_html__('None', 'dit'),
									'both' => esc_html__('Both', 'dit'),
									'top' => esc_html__('Top', 'dit'),
									'bottom' => esc_html__('Bottom', 'dit'),
								),
								'default' => 'none',
							),
							'wrapper-background-gradient-color' => array(
								'title' => esc_html__('Wrapper Background Gradient Color', 'dit'),
								'type' => 'colorpicker',
								'default' => '#000',
