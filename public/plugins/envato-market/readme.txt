...
The latest version of the Envato Market plugin ZIP file can be [**downloaded**](https://envato.github.io/envato-market/dist/envato-market.zip) from https://envato.com/market-plugin/
...
1. Upload `envato-market` to the `/content/plugins/` directory.
