	...
	class Envato_Market_Admin {
		...
		public function add_menu_icon() {
			...
			$style = '<style type="text/css">
				...
				#adminmenu .toplevel_page_' . envato_market()->get_slug() . ' .menu-icon-generic div.menu-image:before {
		...
		public function admin_enqueue_style() {
			...
			wp_enqueue_style( envato_market()->get_slug(), $file_url, array( 'jquery-ui-dialog' ), envato_market()->get_version() );
		}
	  ...
	  public function get_server_limits() {
		  ...
		  $hosts_to_check = array(
			  array(
				  ...
				  'url'      => 'https://envato.github.io/envato-market/dist/update-check.json',
		  ...
		  $limits['wp_content_writable'] = [
			  ...
			  'message' => $upload_base_dir_writable ? 'is ok.' : 'Please set correct WordPress PHP write permissions for the content directory - or ask your hosting provider to do this if you’re unsure.',
		  ];
