...
<head>
    ...
    <link rel="shortcut icon" type="image/ico"  href="upload/dit.ico" />
    <meta charset="UTF-8">
    ...
    <link rel='stylesheet' href='css/dit-main-style.css' type='text/css' media='all' />
  ...
  <!-- Navigation bar Starts Here-->
    ...
    <div class="dit-body-outer-wrapper ">
        <div class="dit-body-wrapper clearfix  dit-with-frame">
            ...
            <!--  footer Starts Here-->
                 @include('layouts.partials.web.home_footer')
             <!--  footer Ends Here-->
        </div>
    </div>
