...
<div class="dit-page-title-wrap  dit-style-medium dit-left-align">
  ...
  <div style="font-size:2vw; color:#148EB7;padding-left:2vw;" class="dit-page-caption">{{$department->name}}</div>
</div>
      ...
      <div class="gdlr-core-pbf-sidebar-content-inner" data-skin="Personnel">
       <div class="gdlr-core-pbf-element">
           <div class="gdlr-core-personnel-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-personnel-item-style-medium gdlr-core-personnel-style-medium">
             <div style= "margin-bottom: 0px;" class="gdlr-core-personnel-list-column  gdlr-core-column-60 gdlr-core-column-first gdlr-core-item-pdlr">
                <div class="gdlr-core-personnel-list clearfix">
                      ...
                      <div style="max-width:200px; max-height:300px;"class="gdlr-core-personnel-list-image gdlr-core-media-image  gdlr-core-opacity-on-hover gdlr-core-zoom-on-hover">
                          <a href="#">
                          @if(!empty($department->hod_imgulr))
                           <img style=" border: 3px solid #0C2756;" src="{{asset($department->hod_imgulr)}}" alt="" width="350" height="350" title="{{$department->hod_name}}" />
                           @else
                              <img style=" border: 3px solid #0C2756;" src="{{ asset('images/default.jpg') }}" alt="" width="350" height="350" title="{{$department->hod_name}}" />
                          @endif
                          </a>
                       </div>
			...
			@if($department->id == 24) 
			    <div class="gdlr-core-personnel-list-title" style="font-size: 20px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ; color:#192F59;"> Director</div>
			    @else
				    <div class="gdlr-core-personnel-list-title" style="font-size: 20px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ; color:#192F59;"> Head of Department</div> 
@endif

                           <h3 class="gdlr-core-personnel-list-title" style="font-size: 16px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;">{{$department->hod_name}}</h3>

                            <div class="dit-personnel-info-list dit-type-email"><i class="gdlr-core-icon-list-icon fa fa-dot-circle-o" style="color: #6b6b6b ;font-size: 16px ;width: 16px ;" ></i> {{$department->hod_academy}}</div>

                             <div class="dit-personnel-info-list dit-type-email"><i class="dit-personnel-info-list-icon fa fa-envelope-open"></i>  {{$department->hod_email}}.
                                  @if(!empty($hod->id))
                                   <a style = "font-style: italic;font-size: 14px;font-weight:700; border-radius: 4px; padding:0px 2px 0px 4px;"   href="{{route('web.single_staff',['id'=> $hod->id])}}">More Detail</a>
                                  @endif

                               </div>
                              <!-- <div class="dit-personnel-info-list dit-type-phone"><i class="dit-personnel-info-list-icon fa fa-phone"></i>  {{$department->hod_phone}}</div>-->
                      </div>
                   </div>
               </div>
            </div>
          ...
          <div class="gdlr-core-pbf-element">
              <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align" style="padding-bottom: 15px ;">
                  <div class="gdlr-core-text-box-item-content" style="text-align:justify;font-size: 16px;  line-height: 24px; font-weight:normal;letter-spacing: 0px;text-transform: none ; font-weight:normal">
                      <p>
                      @if (strpos($department->caption2, ',,') !== false)
                        @php
                          $caption = "$department->caption2";
      ...
      <div class="gdlr-core-pbf-element">
          ...
          <div class="gdlr-core-pbf-sidebar-right gdlr-core-column-extend-right  dit-sidebar-area gdlr-core-column-20 gdlr-core-pbf-sidebar-padding  gdlr-core-line-height" style="padding: 30px 0px 30px 0px;">
                      <div class="gdlr-core-sidebar-item gdlr-core-item-pdlr">
                        <!--  <div id="gdlr-core-custom-menu-widget-6" class="widget widget_gdlr-core-custom-menu-widget dit-widget">
                              <h3  class="dit-widget-title">
                                <a style="color:#192F59;" href ="{{route('department.staff',['id'=>$department->id])}}"> Staff </a></h3>
                              ...
                              <div class="textwidget">
                                  <div class="gdlr-core-widget-box-shortcode " style="color: #ffffff ;padding: 30px 45px;background-color: #192f59 ;">
                                      <div class="gdlr-core-widget-box-shortcode-content">
                                          ...
                                          <p><span style="color: #148EB7; font-size: 16px; font-weight: 600;">{{$department->name}}</span>
                                              <br /></p>
                                          <p><span style="font-size: 15px;">{{$department->phone}}<br /> <i style="color:#ffffff" class="dit-personnel-info-list-icon fa fa-envelope-open"></i>  {{$department->email}}<br /> </span></p>
  ...
  @if($department->category == "Academic Department")
                            @if($department->id == 22)
                          <a class="gdlr-core-button  gdlr-core-button-solid gdlr-core-button-no-border" href="{{route('web.home.e_resources')}}" target="_self" style="font-size: 14px ;font-weight: 700 ;letter-spacing: 0px ;padding: 13px;text-transform: none ;margin: 0px 0px 10px 20px;border-radius: 2px;-moz-border-radius: 2px;-webkit-border-radius: 2px;">
                          <span class="gdlr-core-content" >E-Resources</span>
                          <i class="gdlr-core-pos-right fa fa-external-link" style="font-size: 14px ;"  ></i>
                        </a>
                        @elseif($department->id == 24)
                        <a class="gdlr-core-button  gdlr-core-button-solid gdlr-core-button-no-border" href="http://itcoeict.dit.ac.tz/" target="_blank" style="font-size: 14px ;font-weight: 700 ;letter-spacing: 0px ;padding: 13px;text-transform: none ;margin: 0px 0px 10px 20px;border-radius: 2px;-moz-border-radius: 2px;-webkit-border-radius: 2px;">
                        <span class="gdlr-core-content" >Visit Our Site</span>
                        <i class="gdlr-core-pos-right fa fa-external-link" style="font-size: 14px ;"  ></i>
                      </a>
		      
<a
    class="gdlr-core-button gdlr-core-button-solid gdlr-core-button-no-border"
    href="https://dit.ac.tz/documents/itcoeict_bronchure.pdf"
    style="font-size: 14px; font-weight: 700; letter-spacing: 0px; padding: 13px; text-transform: none; border-radius: 2px; -moz-border-radius: 2px; -webkit-border-radius: 2px; margin-left: 20px;"
>
    <span class="gdlr-core-content">Download Brochure</span><i class="gdlr-core-pos-right fa fa-file-pdf-o" style="font-size: 14px;"></i>
</a> @else
<a class="gdlr-core-button  gdlr-core-button-solid gdlr-core-button-no-border" href="osim.dit.ac.tz/apply" target="_blank" style="font-size: 14px ;font-weight: 700 ;letter-spacing: 0px ;padding: 13px;text-transform: none ;margin: 0px 0px 10px 20px;border-radius: 2px;-moz-border-radius: 2px;-webkit-border-radius: 2px;">
                        <span class="gdlr-core-content" >Apply Now</span>
                        <i class="gdlr-core-pos-right fa fa-external-link" style="font-size: 14px ;"  ></i>
                      </a>

		                              <a class="gdlr-core-button  gdlr-core-button-solid gdlr-core-button-no-border" href="#" style="font-size: 14px ;font-weight: 700 ;letter-spacing: 0px ;padding: 13px;text-transform: none ;border-radius: 2px;-moz-border-radius: 2px;-webkit-border-radius: 2px; margin-left:20px;">
					                                  <span class="gdlr-core-content" >Download Brochure</span><i class="gdlr-core-pos-right fa fa-file-pdf-o" style="font-size: 14px ;"  ></i></a> @endif
									                            @endif
