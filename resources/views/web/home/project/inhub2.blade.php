...
@section('content')
    <div class="dit-page-title-wrap  dit-style-medium dit-left-align">
        ...
        <div style="padding-left:2vw; font-size: 2vw;color:#148EB7" class="dit-page-caption">DIT Publications 2023-2024</div>
    </div>
        ...
        <div class="gdlr-core-page-builder-body">
            <div class="gdlr-core-pbf-sidebar-wrapper " style="margin: 0px 0px 60px 0px;">
                <div style =" margin-right:12px;"
                            ...
                            <div class="gdlr-core-pbf-element">
                                <div
                                    ...
                                    <div class="gdlr-core-divider-line gdlr-core-skin-divider"
                                        style="border-color: #148EB7 ;border-bottom-width: 3px ;"></div>
                                </div>
                            </div>

                            <div class="gdlr-core-pbf-element">
                                <div style="padding:0px;"
                                    class="gdlr-core-accordion-item gdlr-core-item-pdlr gdlr-core-item-pdb  gdlr-core-accordion-style-icon">

                                    <div class=" dit-sidebar-center dit-column-60 dit-line-height">
                                        <div class="gdlr-core-page-builder-body">
                                            <div style="padding-top:0px;"class="gdlr-core-pbf-wrapper ">
                                                <div class="gdlr-core-pbf-wrapper-content gdlr-core-js ">
                                                    <div
                                                        class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
                                                        <div style="padding:0px;" class="gdlr-core-pbf-element">
                                                            <div style="padding:0px;"
                                                                ...
                                                                <div style="padding: 5px 5px 0px 10px;"
                                                                    class="gdlr-core-course-item-list">
                                                                        ...
                                                                        <div class="gdlr-core-accordion-item-tab clearfix ">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <h4
                                                                                    ...
                                                                                    JOURNAL PAPERS PUBLISHED DURING THE FINANCIAL YEAR 2023/2024
                                                                                </h4>
                                                                                <div style="padding-bottom:0px;padding-top:2px; padding-left:20px; font-size: 16px; font-weight:normal;  letter-spacing: 0px;"
                                                                                    class="gdlr-core-accordion-item-content">
                                                                                    <span
                                                                                        class="gdlr-core-icon-list-icon-wrap"
                                                                                        style="margin-top: 1px ; padding-right: 8px;"><i
                                                                                            class="gdlr-core-icon-list-icon fa fa-hand-o-right"
                                                                                            style="color: #6b6b6b ;font-size: 22px ;width: 22px ;"></i>
                                                                                          </span>
                                                                                    <a href="https://dit.ac.tz/documents/dit_publication_2023_2024.pdf" target="_blank" class="gdlr-core-course-item-button gdlr-core-button">View</a>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <!--<a href="https://www.ahead-project.net/" target="_blank" class="gdlr-core-course-item-button gdlr-core-button">More Detail</a> -->
                                                                </div>
                    ...
                    <div class="gdlr-core-pbf-sidebar-right gdlr-core-column-extend-right  dit-sidebar-area gdlr-core-column-20 gdlr-core-pbf-sidebar-padding  gdlr-core-line-height"
                        style="padding: 54px 0px 30px 0px;">
                        <div style="padding-left:0px; padding-right:0px;"
                            class="gdlr-core-sidebar-item gdlr-core-item-pdlr">
                            @include('layouts.partials.web.quick_links')

                            <a class="gdlr-core-button  gdlr-core-button-solid gdlr-core-button-no-border"
                                href="https://osim.dit.ac.tz/apply" target="_blank"
                                style="font-size: 14px ;font-weight: 700 ;letter-spacing: 0px ;padding: 13px;text-transform: none ;margin: 0px 0px 10px 20px;border-radius: 2px;-moz-border-radius: 2px;-webkit-border-radius: 2px;">
                                <span class="gdlr-core-content">Apply Now</span><i
                                    class="gdlr-core-pos-right fa fa-external-link" style="font-size: 14px ;"></i></a><a
                                class="gdlr-core-button  gdlr-core-button-solid gdlr-core-button-no-border" href="#"
                                ...
                                <span class="gdlr-core-content">Download Brochure</span><i
