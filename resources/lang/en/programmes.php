...
return [
    ...
    'index_route_description' => 'Retrieve existing programmes.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the programme property name where the value is the assigned value to the retrieved programme.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved programme.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of programmes per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved programme.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new programme.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing programme.',
    ...
    'show_route_description' => 'Retrieve existsing programme.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the programme to retrieve',
    'destroy_route_description' => 'Delete existsing programme.',
    ...
    'the_id_of_model_to_delete' => 'The id of the programme to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete programmes.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the programme.',
    ...
    'the_requested_model_does_not_exists' => 'The requested programme does not exists.',
    ...
    'edit' => 'Edit Programme',
    'show' => 'Show Programme',
    'show_all' => 'Show All Programme',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Programme.',
    'none_available' => 'No Programmes Available.',
    'model_plural' => 'Programmes',
    'model_was_added' => 'Programme was successfully added.',
    'model_was_retrieved' => 'Programme was successfully retrieved.',
    'models_were_retrieved' => 'Programmes were successfully retrieved.',
    'model_was_updated' => 'Programme was successfully updated.',
    'model_was_deleted' => 'Programme was successfully deleted.',
    ...
    'model_id_camel_case' => 'programmeId',
