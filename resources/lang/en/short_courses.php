...
return [
    ...
    'index_route_description' => 'Retrieve existing short courses.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the short course property name where the value is the assigned value to the retrieved short course.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved short course.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of short courses per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved short course.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new short course.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing short course.',
    ...
    'show_route_description' => 'Retrieve existsing short course.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the short course to retrieve',
    'destroy_route_description' => 'Delete existsing short course.',
    ...
    'the_id_of_model_to_delete' => 'The id of the short course to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete short courses.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the short course.',
    ...
    'the_requested_model_does_not_exists' => 'The requested short course does not exists.',
    ...
    'create' => 'Create New Short Course',
    'delete' => 'Delete Short Course',
    'edit' => 'Edit Short Course',
    'show' => 'Show Short Course',
    'show_all' => 'Show All Short Course',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Short Course.',
    'none_available' => 'No Short Courses Available.',
    'model_plural' => 'Short Courses',
    'model_was_added' => 'Short Course was successfully added.',
    'model_was_retrieved' => 'Short Course was successfully retrieved.',
    'models_were_retrieved' => 'Short Courses were successfully retrieved.',
    'model_was_updated' => 'Short Course was successfully updated.',
    'model_was_deleted' => 'Short Course was successfully deleted.',
    ...
    'model_id_camel_case' => 'short courseId',
