...
return [
    ...
    'index_route_description' => 'Retrieve existing experiences.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the experience property name where the value is the assigned value to the retrieved experience.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved experience.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of experiences per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved experience.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new experience.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing experience.',
    ...
    'show_route_description' => 'Retrieve existsing experience.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the experience to retrieve',
    'destroy_route_description' => 'Delete existsing experience.',
    ...
    'the_id_of_model_to_delete' => 'The id of the experience to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete experiences.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the experience.',
    ...
    'the_requested_model_does_not_exists' => 'The requested experience does not exists.',
    ...
    'show_all' => 'Show All Experience',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Experience.',
    'none_available' => 'No Experiences Available.',
    'model_plural' => 'Experiences',
    'model_was_added' => 'Experience was successfully added.',
    'model_was_retrieved' => 'Experience was successfully retrieved.',
    'models_were_retrieved' => 'Experiences were successfully retrieved.',
    'model_was_updated' => 'Experience was successfully updated.',
    'model_was_deleted' => 'Experience was successfully deleted.',
    ...
    'model_id_camel_case' => 'experienceId',
