...
return [
    ...
    'added_by' => 'Added By',
    'added_by__placeholder' => 'Select added by',
    'verified_by' => 'Verified By',
    'verified_by__placeholder' => 'Select verified by',
    'title' => 'Title',
    'title__placeholder' => 'Enter title here...',
    'urllink' => 'Urllink',
    'urllink__placeholder' => 'Enter urllink here...',
    'status' => 'Status',
    ...
    'index_route_description' => 'Retrieve existing quick links.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the quick link property name where the value is the assigned value to the retrieved quick link.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved quick link.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of quick links per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved quick link.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new quick link.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing quick link.',
    ...
    'show_route_description' => 'Retrieve existsing quick link.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the quick link to retrieve',
    'destroy_route_description' => 'Delete existsing quick link.',
    ...
    'the_id_of_model_to_delete' => 'The id of the quick link to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete quick links.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the quick link.',
    ...
    'the_requested_model_does_not_exists' => 'The requested quick link does not exists.',
    ...
    'create' => 'Create New Quick Link',
    'delete' => 'Delete Quick Link',
    'edit' => 'Edit Quick Link',
    'show' => 'Show Quick Link',
    'show_all' => 'Show All Quick Link',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Quick Link.',
    'none_available' => 'No Quick Links Available.',
    'model_plural' => 'Quick Links',
    'model_was_added' => 'Quick Link was successfully added.',
    'model_was_retrieved' => 'Quick Link was successfully retrieved.',
    'models_were_retrieved' => 'Quick Links were successfully retrieved.',
    'model_was_updated' => 'Quick Link was successfully updated.',
    'model_was_deleted' => 'Quick Link was successfully deleted.',
    ...
    'model_id_camel_case' => 'quick linkId',
